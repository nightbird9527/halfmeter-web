...
import menuRoutesConfig, {type IMenuRouteConfigItem} from './menuRoutes';
...
const SiderBar: React.FC<ISiderBarProps> = (props) => {
  const {
    siderStyle: {siderBgColor, siderTextColor, siderBorderColor},
  } = props;
  ...
  const menuItems = getMenuItems(menuRoutesConfig, null);
